									...
									<div class="col-md-10">
										<div class="card">
											<div class="card-body">
												...
												<div class="mb-10">
													<label class="col-form-label col-md-4 text-white">Gambar</label> <br>
												...
												<div class="mb-10">
													<label class="col-form-label col-md-4 text-white">Judul Post</label>
												...
												<div class="mb-20">
													<label class="col-form-label col-md-4 text-white">Konten</label>
