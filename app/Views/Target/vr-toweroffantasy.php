    ...
    <div class="col">
        <select placeholder="Pilih Server" name="zone_id" class="form-control">
            <option value="">Pilih Server</option>
                                ...
                                <option value="Asia Pacific-Vega">Asia Pacific-Vega</option>
                                <option value="Asia Pacific-Neptune">Asia Pacific-Neptune</option>
                                <option value="Asia Pacific-Tenpura">Asia Pacific-Tenpura</option>
                                <option value="Asia Pacific-Moon">Asia Pacific-Moon</option>
                                <option value="Asia Pacific-Mihashira">Asia Pacific-Mihashira</option>
                                ...
                                <option value="Europe-Seaforth Dock">Europe-Seaforth Dock</option>
                                <option value="Europe-Silvercoast Lab">Europe-Silvercoast Lab</option>
                                ...
                                <option value="North America-Ozera">North America-Ozera</option>
                                ...
                                <option value="Southeast Asia-Oneiros">Southeast Asia-Oneiros</option>
                                <option value="Southeast Asia-Famtosyana">Southeast Asia-Famtosyana</option>
                                      </select>
                                    </select>
    </div>
</div>        